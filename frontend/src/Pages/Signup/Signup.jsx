    ...
    return (
        <div>
            <form action="" className='form-control'>
                ...
                <GenderCheckBox/>
                <textarea className="textarea textarea-bordered flex items-center gap-2 mt-2 w-full" placeholder="Bio"></textarea>  
                <button className="btn btn-primary w-full mt-4">Signup</button>
            </form>
            <div className='mt-4'>Already have an account? <a href="/login" className='link'>Login</a></div>
        </div>
    )
}
